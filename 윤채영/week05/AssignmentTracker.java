...
public class AssignmentTracker {
    ...
    public List<String> getNotSubmitted(String assignment, List<String> allStudents) {
        ...
        List<String> allList = new ArrayList<>(allStudents);
        allList.removeAll(submissions.get(assignment));
    ...
    public double getSubmissionRate(String assignment, int totalStudents) {
        ...
        double submitSize = submissions.get(assignment).size();
        double submitRate = (submitSize/totalStudents)*100;
        return submitRate;
    }
    ...
    public void printReport() {
        ...
        for (String assignment : assignments) {
            List<String> sorted = new ArrayList<>(submissions.get(assignment));
            Collections.sort(sorted);
            System.out.println("과제: " + assignment);
            System.out.println("제출자: " + sorted);
        }
